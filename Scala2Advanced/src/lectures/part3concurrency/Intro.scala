...
object Intro extends App {
  ...
  aThread.start() // gives the signal to the JVM to start thread
  // creates a JVM thread on top of OS thread
  runnable.run // just executes the method in the main thread
  aThread.join() // blocks the main thread until 'aThread' finishes running
...
//  pool.shutdownNow() // interrupts execution of running threads
